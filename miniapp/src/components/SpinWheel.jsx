...
export default function SpinWheel({ user, refreshUser }) {
  ...
  return (
    <Card className="mb-4 bg-gradient-to-b from-[#0F0A1F] to-[#070510] relative overflow-hidden border border-indigo-500/20  rounded-[2rem] p-0">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex flex-col">
             <div className="flex items-center gap-2">
              <h2 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-600 uppercase tracking-wider flex items-center gap-2 ">
          ...
          <AnimatePresence mode="wait">
            {!reward ? (
              ...
              >
                ...
                <div className="absolute -inset-4 rounded-full border-4 border-[#2D2459]  bg-[#130E26]">
                ...
                {/* The Pointer */}
                <div className="absolute -top-7 left-1/2 -translate-x-1/2 z-30 drop- filter">
                ...
                >
                  ...
                  {PRIZES.map((prize, i) => {
                    ...
                    return (
                      ...
                      >
                        <Icon size={20} color={prize.text} className="mb-1.5 opacity-90 filter " />
                        <span className="font-black text-[15px]  tracking-tight" style={{ color: prize.text }}>
                          {prize.label}
                        </span>
                      </div>
                    );
                  ...
                  {/* Center Glossy Peg */}
                  <div className="absolute inset-0 m-auto w-16 h-16 rounded-full z-10 flex items-center justify-center border-4 border-[#130E26] ">
              ...
              >
                ...
                <h3 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-amber-400 to-yellow-600 mb-2  uppercase tracking-wider">
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-400 hover:to-amber-500 text-black font-black border-none px-10 py-4 rounded-2xl text-lg  active:translate-y-[2px] transition-all"
                >
                  COLLECT REWARD
                </Button>
              </motion.div>
